...
const HeroSection = () => {
  return (
    <section className="relative flex flex-col items-center justify-center text-center min-h-[80vh] px-6 py-20 bg-gradient-to-br from-amber-100 via-orange-100 to-green-100 overflow-hidden">
      ...
      <div className="absolute -top-40 -left-40 w-96 h-96 bg-green-300 rounded-full mix-blend-multiply filter blur-3xl opacity-50"></div>
      <div className="absolute bottom-0 right-0 w-[32rem] h-[32rem] bg-amber-300 rounded-full mix-blend-multiply filter blur-3xl opacity-50"></div>
